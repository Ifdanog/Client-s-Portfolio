      ...
      <header>
        <div className="w-full md:w-3/5 ml-0 md:ml-20 mt-20 text-center md:text-left">
          ...
          <a href='https://wa.me/message/VQDOTEJEAELOJI' target='_blank'>
            <button className='mt-10 text-sm md:text-normal px-4 py-2 border border-white rounded-full text-white hover:bg-gold hover:text-white'>CONTACT ME NOW</button>
          </a>
        </div>
      </header>
      <Showcases />
